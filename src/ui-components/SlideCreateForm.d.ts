...
export declare type SlideCreateFormProps = React.PropsWithChildren<{
    ...
    onSubmit?: (fields: SlideCreateFormInputValues) => SlideCreateFormInputValues;
    onSuccess?: (fields: SlideCreateFormInputValues) => void;
    onError?: (fields: SlideCreateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: SlideCreateFormInputValues) => SlideCreateFormInputValues;
    onValidate?: SlideCreateFormValidationValues;
} & React.CSSProperties>;
export default function SlideCreateForm(props: SlideCreateFormProps): React.ReactElement;
