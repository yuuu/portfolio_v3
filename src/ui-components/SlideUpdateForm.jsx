...
export default function SlideUpdateForm(props) {
  const {
    id: idProp,
    slide: slideModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(Slide, idProp)
        : slideModelProp;
      setSlideRecord(record);
    };
    queryData();
  }, [idProp, slideModelProp]);
  React.useEffect(resetStateValues, [slideRecord]);
  const validations = {
    link: [{ type: "Required" }],
    image: [{ type: "Required" }],
    title: [{ type: "Required" }],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            Slide.copyOf(slideRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "SlideUpdateForm")}
      {...rest}
    >
      <TextField
        label="Link"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || slideModelProp)}
