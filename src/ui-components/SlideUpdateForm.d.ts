...
export declare type SlideUpdateFormProps = React.PropsWithChildren<{
    ...
    onError?: (fields: SlideUpdateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: SlideUpdateFormInputValues) => SlideUpdateFormInputValues;
    onValidate?: SlideUpdateFormValidationValues;
} & React.CSSProperties>;
export default function SlideUpdateForm(props: SlideUpdateFormProps): React.ReactElement;
